...
Original file is located at
    https://colab.research.google.com/drive/1riQTLPTnqghzt2EmsiPX8XjIfYK2w3E0
"""
...
data["Customer_For"] = pd.to_numeric(data["Customer_For"], errors="coerce")  # coerce used to make all type of values into one type
